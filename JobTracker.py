...
def init():
    global toggle
    global TaskList,ProjectList,NumTasks,saveLocation,open_time
...
def savelist():
    global TaskList,ProjectList,NumTasks,saveLocation
...
def run():
    global codejob,tutorjob,hcjob,tempjob,restojob
    global TaskList,ProjectList,NumTasks,saveLocation,open_time,cheers
